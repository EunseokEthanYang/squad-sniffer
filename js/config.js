...
Sniffer.config = {
  ...
  voice: {
    ...
    agents: { enabled: 'auto', vn: true, maxChars: 1500, speed: 1.05,   // 'auto': 서버 TTS(LOCAL_TTS=1)가 있을 때만 말한다 · true: 브라우저 음성으로라도 · false: 창만   // 답은 끝까지 읽는다(문장 단위로 나눠 먼저 나온 문장부터). 너무 길면 이하 생략
